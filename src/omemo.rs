...
#[no_mangle]
pub unsafe extern "C" fn omemo_add_group_participant(
    gs: *mut GroupSession,
    id: *const c_char,
    s: *mut OlmSession,
) {
...
#[no_mangle]
pub unsafe extern "C" fn omemo_decrypted_size(
    gs: *mut GroupSession,
    ct: *const u8,
    ct_len: size_t,
) -> size_t {
...
#[no_mangle]
pub unsafe extern "C" fn omemo_encrypt(
    gs: *mut GroupSession,
    pt: *const u8,
    pt_len: size_t,
    ct: *mut u8,
...
#[no_mangle]
pub unsafe extern "C" fn omemo_decrypt(
    gs: *mut GroupSession,
    id: *const c_char,
    pt: *mut u8,
    pt_len: size_t,
